...
var grammar = {
    ...
    {"name": "Expression", "symbols": ["Expression", "_", (lexer.has("variable") ? {type: "variable"} : variable)], "postprocess": d => semaIR.setvar(d[2],d[0])},
    {"name": "ParameterList", "symbols": [(lexer.has("paramBegin") ? {type: "paramBegin"} : paramBegin), "_", "Params", "_", (lexer.has("paramEnd") ? {type: "paramEnd"} : paramEnd)], "postprocess": d => ({"paramBegin":d[0], "@params":d[2], "paramEnd":d[4]} )},
    ...
    {"name": "ParamElement", "symbols": [(lexer.has("paramBegin") ? {type: "paramBegin"} : paramBegin), "_", "Params", "_", (lexer.has("paramEnd") ? {type: "paramEnd"} : paramEnd)], "postprocess": (d) => ({"@list":d[2]})},
